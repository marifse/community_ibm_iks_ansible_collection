...
class TestIbmContainerMonitoringConfigRemove(unittest.TestCase):
    ...
    def test_run_module_successful(self, mock_fail_json, mock_exit_json, mock_remove_config, mock_get_refresh_token, mock_get_iam_token):
        mock_get_iam_token.return_value = "mocked_iam_token"
        mock_get_refresh_token.return_value = "mocked_refresh_token"
        mock_remove_config.return_value = (False, True, "mocked_monitoring_info")
        ...
        mock_remove_config.assert_called_once_with(module.params)
