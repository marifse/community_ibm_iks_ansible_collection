...
from plugins.modules.ibm_container_monitoring_config_discover import run_module

class TestIbmContainerMonitoringConfigDiscover(unittest.TestCase):
    ...
    @patch.object(Monitoring, "discover_config_monitoring")
    @patch.object(AnsibleModule, "exit_json")
    @patch.object(AnsibleModule, "fail_json")
    def test_run_module_successful(self, mock_fail_json, mock_exit_json, mock_discover_config, mock_get_refresh_token, mock_get_iam_token):
        mock_get_iam_token.return_value = "mocked_iam_token"
        mock_get_refresh_token.return_value = "mocked_refresh_token"
        mock_discover_config.return_value = (False, True, "mocked_monitoring_info")
        ...
        mock_discover_config.assert_called_once_with(module.params)
