...
from community_ibm_iks_ansible_collections.ibm.custom_iks_collection.plugins.modules.ibm_container_pull_secret_enable import run_module

class TestIbmContainerPullSecretEnable(unittest.TestCase):
    @patch("community_ibm_iks_ansible_collections.ibm.custom_iks_collection.plugins.modules.ibm_container_pull_secret_enable.Authenticator")
    @patch("community_ibm_iks_ansible_collections.ibm.custom_iks_collection.plugins.modules.ibm_container_pull_secret_enable.Beta")
    @patch("community_ibm_iks_ansible_collections.ibm.custom_iks_collection.plugins.modules.ibm_container_pull_secret_enable.AnsibleModule")
    def test_run_module_successful(self, mock_ansible_module, mock_beta, mock_authenticator):
        ...
        mock_beta_instance.enablePullSecret.return_value = (False, True)
        ...
        mock_beta_instance.enablePullSecret.assert_called_once_with(args)
