...
from ibm.custom_iks_collection.plugins.modules.ibm_container_ingress_alb_enable import run_module

class TestIBMContainerIngressALBEnableModule(unittest.TestCase):
    ...
    def test_successful_enable_alb(self):
        mock_ingress_alb_beta = MagicMock()
        mock_ingress_alb_beta.enableAlb.return_value = (False, True)

        with unittest.mock.patch(
            "ibm.custom_iks_collection.plugins.modules.ibm_container_ingress_alb_enable.IngressALBBeta",
            return_value=mock_ingress_alb_beta
        ):
            with unittest.mock.patch(
                "ibm.custom_iks_collection.plugins.modules.ibm_container_ingress_alb_enable.Authenticator.get_iam_token",
    ...
    def test_error_enabling_alb(self):
        mock_ingress_alb_beta = MagicMock()
        mock_ingress_alb_beta.enableAlb.return_value = (True, False)
            ...
            with unittest.mock.patch(
                ...
                with unittest.mock.patch(
                    ...
                    mock_module.return_value.fail_json.assert_called_with(
                        msg="Error enabling ingress alb"
                    )
