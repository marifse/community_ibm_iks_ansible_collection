...
DOCUMENTATION = r"""
---
module: ibm_container_private_service_endpoint_disable
author: arifnafees (@marifse)
version_added: "1.0.0"
short_description: Disables a private service endpoint for a cluster
requirements: []
description:
...
options:
    ...
    config:
        ...
        suboptions:
            cluster:
                description:
                    - The cluster id on which the private service endpoint is to disabled
                required: True
                type: str
"""
...
- ibm_container_private_service_endpoint_disable:
...
def run_module():
    ...
    is_error, has_changed = sdk.disablePrivateServiceEndpoint(module.params)
