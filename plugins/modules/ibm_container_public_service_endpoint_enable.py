...
DOCUMENTATION = r"""
---
module: ibm_container_public_service_endpoint_enable
author: arifnafees (@marifse)
version_added: "1.0.0"
short_description: Enables the public service endpoint for a cluster.
requirements: []
description:
...
options:
    ...
    config:
        ...
        suboptions:
            cluster:
                description:
                    - The cluster id on which the public service endpoint is to be enabled
                required: True
                type: str
"""
...
- ibm_container_public_service_endpoint_enable:
...
def run_module():
    ...
    is_error, has_changed = sdk.enablePublicServiceEndpoint(module.params)

    if not is_error:
        module.exit_json(changed=has_changed)
    else:
        module.fail_json(msg="Error enabling public service endpoint")
