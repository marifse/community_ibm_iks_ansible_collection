...
DOCUMENTATION = r"""
---
module: ibm_container_image_security_disable
author: arifnafees (@marifse)
version_added: "1.0.0"
short_description: Disable image security enforcement for a cluster
requirements: []
description:
...
options:
    ...
    config:
        ...
        suboptions:
            cluster:
                description:
                    - The cluster id on which the image security is to be disabled.
                required: True
                type: str
"""
...
- ibm_container_image_security_disable:
...
def run_module():
    ...
    is_error, has_changed = sdk.disableImageSecurity(module.params)

    if not is_error:
        module.exit_json(changed=has_changed)
    else:
        module.fail_json(msg="Error disabling image security")
