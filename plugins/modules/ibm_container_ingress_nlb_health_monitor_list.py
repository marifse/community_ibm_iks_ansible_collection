...
DOCUMENTATION = r"""
---
module: ibm_container_ingress_nlb_health_monitor_list
...
- ibm_container_ingress_nlb_health_monitor_list:
...
def run_module():
    module_args = dict(
        ...
        config=dict(
            required=True,
            type="dict",
            options=dict(idOrName=dict(required=True, type="str")),
        ),
    )
    ...
    is_error, has_changed, alb_config = sdk.listHealthCheckMonitorALB(module.params)
