...
def run_module():
    ...
    is_error, has_changed = sdk.enablePrivateServiceEndpoint(module.params)

    if not is_error:
        module.exit_json(changed=has_changed)
    else:
        module.fail_json(msg="Error enabling private service endpoint")
