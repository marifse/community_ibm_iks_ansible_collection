ibm.container_public_service_endpoint_disable module -- Disable the public service endpoint in an IBM Kubernetes Cluster
========================================================================================================================
...
To use it in a playbook, specify: :code:`ibm.container_public_service_endpoint_disable`.
...
This module disables the public service endpoint in an IBM IKS cluster.
