ibm.container_ingress_nlb_health_monitor_list module -- List the health check monitor settings for all NLB subdomains.
=====================================================================================================================
...
To install it, use: ansible-galaxy collection install ibm. You need further requirements to be able to use this module, see :ref:`Requirements <ansible_collections.ibm.ibm_container_ingress_nlb_health_monitor_list_module_requirements>` for details.

To use it in a playbook, specify: :code:`ibm.container_ingress_nlb_health_monitor_list`.
...
- This module List the health check monitor settings for all NLB subdomains. 
...
.. raw:: html
  ...
  <tr class="row-even">
    ...
    <td><div class="ansible-option-cell">
      <p>Cluster Name.</p>
      <p class="ansible-option-line"><span class="ansible-option-choices">Cluster Name / ID, on which to list the settings for all existing health check monitors:</span></p>
    </div></td>
  </tr>
