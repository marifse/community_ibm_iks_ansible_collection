ibm.container_replace_worker module -- Replaces the worker node in an IBM Kubernetes Cluster
===================================================
...
To install it, use: ansible-galaxy collection install ibm. You need further requirements to be able to use this module, see :ref:`Requirements <ansible_collections.ibm.ibm_container_replace_worker_module_requirements>` for details.

To use it in a playbook, specify: :code:`ibm.container_replace_worker`.
...
This module replaces the worker node in an IBM Kubernetes cluster.
